					...
					<div class="border border-gray bg-light rounded-3 p-3" style="width: 380px">
						...
						?>
							<form method="post">
								...
								<input type="text" placeholder=" Name" name="user_name" class="form-control border border-success">
								...
								<label class="text-dark mt-3">User Mobile</label>
								<!-- onKeyPress="if (this.value.length == 10) return false;" -->
								<input type="number" onKeyPress="if (this.value.length == 10) return false;" placeholder="Mobile" name="user_mobile" class="form-control border border-success">

								<button type="submit" name="register" class=" mt-2 rounded-2 border-0 text-white w-100 fw-bold bg-color p-3">Register</button>
